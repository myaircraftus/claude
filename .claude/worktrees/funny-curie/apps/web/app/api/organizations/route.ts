...
export async function POST(req: NextRequest) {
  try {
    ...
    // 5. Insert owner membership — use service role to bypass bootstrap RLS chicken-and-egg
    //    (user can't satisfy has_org_role check before their first membership is inserted)
