...
import { FounderNoteModal } from '@/components/onboarding/founder-note-modal'
...
export default function OnboardingPage() {
  ...
  // showFounderNote starts as null (unknown) to avoid flicker before localStorage is checked.
  // FounderNoteModal itself handles the localStorage check and calls onDismiss immediately
  // if already seen — so we can always mount it and let it decide.
  const [showFounderNote, setShowFounderNote] = useState(true)

  function handleFounderNoteDismiss() {
  ...
  return (
    <>
      {/* Founder note modal — overlays everything on first visit */}
      {showFounderNote && (
