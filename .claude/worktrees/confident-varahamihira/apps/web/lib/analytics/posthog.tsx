...
export const track = {
  ...
  // Atlas Parts Network events
  partSearchRun: (props: {
    aircraft_id?: string
    work_order_id?: string
    query_type?: string
    result_count?: number
  }) => posthog.capture('part_search_run', props),

  partOfferClick: (props: {
    organization_id?: string
    aircraft_id?: string
    work_order_id?: string
    provider?: string
    result_count?: number
  }) => posthog.capture('part_offer_click', props),

  partOrderStatusChanged: (props: { status: string }) =>
    posthog.capture('part_order_status_changed', props),

  partAttachedToWorkOrder: (props: { work_order_id: string }) =>
    posthog.capture('part_attached_to_work_order', props),
}
