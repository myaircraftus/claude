  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      <Topbar
        ...
        actions={
          <div className="flex gap-2">
            <Link
              href={`/ask?aircraft=${aircraft.id}`}
              className="inline-flex items-center gap-2 text-[#0f172a] px-3 py-1.5 rounded-lg text-[13px] font-medium transition-colors hover:bg-[#f1f3f8]"
            ...
            <Link
              href={`/documents/upload?aircraft=${aircraft.id}`}
              className="inline-flex items-center gap-2 text-white px-3 py-1.5 rounded-lg text-[13px] font-medium transition-colors"
      ...
      <main className="flex-1 overflow-y-auto">
        ...
        <div className="px-6 pt-6 pb-4 bg-white" style={{ borderBottom: '1px solid rgba(15,23,42,0.08)' }}>
          <div className="max-w-7xl mx-auto">
            <div className="flex items-start gap-4">
              ...
              >
                <Plane className="h-7 w-7 text-[#0c2d6b]" />
              </div>
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-3 flex-wrap">
                  <h1 className="font-mono text-[28px] font-bold text-[#0f172a] tracking-wide">
                ...
                <p className="text-[#64748b] text-[13px] mt-0.5">
                  ...
                  {aircraft.engine_make && ` · ${aircraft.engine_make} ${aircraft.engine_model ?? ''}`}
                </p>
                <div className="flex flex-wrap gap-2 mt-2">
                  {aircraft.base_airport && (
                    <span
                      className="text-[11px] text-[#64748b] px-2 py-0.5 rounded-full flex items-center gap-1"
                      style={{ border: '1px solid rgba(15,23,42,0.08)' }}
                    >
                  ...
                  <span
                    className="text-[11px] text-[#64748b] px-2 py-0.5 rounded-full"
                    style={{ border: '1px solid rgba(15,23,42,0.08)' }}
                  >
        ...
        <div className="px-6 py-6">
          <div className="max-w-7xl mx-auto">
            <Tabs defaultValue="overview">
              <TabsList className="mb-6 flex-wrap h-auto gap-1 bg-transparent p-0 border-b border-[rgba(15,23,42,0.08)] rounded-none pb-0">
                <TabsTrigger value="overview" className="flex items-center gap-1.5 rounded-none border-b-2 border-transparent data-[state=active]:border-[#0c2d6b] data-[state=active]:text-[#0c2d6b] data-[state=active]:shadow-none bg-transparent px-3 py-2 text-[13px]">
                  <Plane className="h-3.5 w-3.5" />
                  Overview
                </TabsTrigger>
                <TabsTrigger value="documents" className="flex items-center gap-1.5 rounded-none border-b-2 border-transparent data-[state=active]:border-[#0c2d6b] data-[state=active]:text-[#0c2d6b] data-[state=active]:shadow-none bg-transparent px-3 py-2 text-[13px]">
                  <FileText className="h-3.5 w-3.5" />
                  Documents
                  {documents.length > 0 && (
                    <span className="ml-1 text-[10px] font-semibold bg-[#e8edf5] text-[#0c2d6b] px-1.5 py-0.5 rounded-full">
                      {documents.length}
                    </span>
                  )}
                </TabsTrigger>
                <TabsTrigger value="ask" className="flex items-center gap-1.5 rounded-none border-b-2 border-transparent data-[state=active]:border-[#0c2d6b] data-[state=active]:text-[#0c2d6b] data-[state=active]:shadow-none bg-transparent px-3 py-2 text-[13px]">
                  <MessageSquare className="h-3.5 w-3.5" />
                  Ask
                </TabsTrigger>
                <TabsTrigger value="timeline" className="flex items-center gap-1.5 rounded-none border-b-2 border-transparent data-[state=active]:border-[#0c2d6b] data-[state=active]:text-[#0c2d6b] data-[state=active]:shadow-none bg-transparent px-3 py-2 text-[13px]">
                ...
                <TabsTrigger value="ads" className="flex items-center gap-1.5 rounded-none border-b-2 border-transparent data-[state=active]:border-[#0c2d6b] data-[state=active]:text-[#0c2d6b] data-[state=active]:shadow-none bg-transparent px-3 py-2 text-[13px]">
                ...
                <TabsTrigger value="reminders" className="flex items-center gap-1.5 rounded-none border-b-2 border-transparent data-[state=active]:border-[#0c2d6b] data-[state=active]:text-[#0c2d6b] data-[state=active]:shadow-none bg-transparent px-3 py-2 text-[13px]">
                ...
                <TabsTrigger value="entries" className="flex items-center gap-1.5 rounded-none border-b-2 border-transparent data-[state=active]:border-[#0c2d6b] data-[state=active]:text-[#0c2d6b] data-[state=active]:shadow-none bg-transparent px-3 py-2 text-[13px]">
                ...
                <TabsTrigger value="settings" className="flex items-center gap-1.5 rounded-none border-b-2 border-transparent data-[state=active]:border-[#0c2d6b] data-[state=active]:text-[#0c2d6b] data-[state=active]:shadow-none bg-transparent px-3 py-2 text-[13px]">
