...
function AppLayoutInner({
  ...
  const adminNavItems: NavItem[] = [
    ...
    // Documents — the platform-admin Document Pipeline monitor: live
    // ingestion progress, stuck-doc retry, worker heartbeats, and the
    // human-review queue. NOT the org document library at /documents
    // (that's the owner/shop surface).
