        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <FadeIn delay={0.2}>
            <div className="flex items-center justify-center gap-4 flex-wrap">
              ...
              <Link href="/app" className="inline-flex items-center gap-2 border border-white/20 text-white/70 hover:text-white hover:border-white/40 px-6 py-3 rounded-xl text-[14px] transition-all" style={{ fontWeight: 500 }}>
      ...
      <section className="px-4 py-20">
        <div className="max-w-2xl mx-auto text-center">
          <FadeIn>
            ...
            <p className="text-white/45 text-[16px] mb-8">30-day free trial. Free on-site scanning. Cancel anytime.</p>
            <div className="flex items-center justify-center gap-4 flex-wrap">
