// Aircraft Intelligence — Market Value Estimate.
...
import { MarketValueClient, type MarketValueReport } from './market-value-client'

export const dynamic = 'force-dynamic'
export const metadata = { title: 'Market Value Estimate' }

export default async function MarketValuePage({ params }: { params: { id: string } }) {
          ...
          <div className="max-w-5xl mx-auto">
            <div className="mt-8 flex flex-col items-center justify-center gap-3 rounded-xl border border-border bg-white py-16 px-6 text-center">
              ...
              <p className="text-xs text-muted-foreground max-w-md">
                ...
                view the Market Value Estimate.
              </p>
            </div>
          </div>
        </main>
  ...
  let initialReport: MarketValueReport | null = null
  try {
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      ...
      />
      <IntelligenceModuleNav aircraftId={aircraftId} active="market-value" />
      <main className="flex-1 overflow-y-auto">
        <MarketValueClient aircraftId={aircraftId} initialReport={initialReport} />
      </main>
    </div>
  )
}
