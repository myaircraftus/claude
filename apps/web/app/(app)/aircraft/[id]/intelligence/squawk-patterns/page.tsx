// Aircraft Intelligence — Recurring Squawk Patterns.
...
import { SquawkPatternsClient, type SquawkPatternsReport } from './squawk-patterns-client'

export const dynamic = 'force-dynamic'
export const metadata = { title: 'Recurring Squawk Patterns' }

export default async function SquawkPatternsPage({ params }: { params: { id: string } }) {
          ...
          <div className="max-w-5xl mx-auto">
            <div className="mt-8 flex flex-col items-center justify-center gap-3 rounded-xl border border-border bg-white py-16 px-6 text-center">
              ...
              <p className="text-xs text-muted-foreground max-w-md">
                ...
                view Recurring Squawk Patterns.
              </p>
            </div>
          </div>
        </main>
  ...
  let initialReport: SquawkPatternsReport | null = null
  try {
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      ...
      />
      <IntelligenceModuleNav aircraftId={aircraftId} active="squawk-patterns" />
      <main className="flex-1 overflow-y-auto">
        <SquawkPatternsClient aircraftId={aircraftId} initialReport={initialReport} />
      </main>
    </div>
  )
}
