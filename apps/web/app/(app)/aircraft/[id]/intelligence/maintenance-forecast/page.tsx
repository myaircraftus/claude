// Aircraft Intelligence — Maintenance Forecast.
...
import { MaintenanceForecastClient, type ForecastReport } from './maintenance-forecast-client'

export const dynamic = 'force-dynamic'
export const metadata = { title: 'Maintenance Forecast' }
...
export default async function MaintenanceForecastPage({
  ...
  try {
    ...
    if (cached) {
      initialReport = { ...(cached.result_json as object), cached: true } as ForecastReport
    }
  } catch {
    initialReport = null
  }
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      ...
      />
      <IntelligenceModuleNav aircraftId={aircraftId} active="maintenance-forecast" />
      <main className="flex-1 overflow-y-auto">
        <MaintenanceForecastClient aircraftId={aircraftId} initialReport={initialReport} />
      </main>
    </div>
  )
}
