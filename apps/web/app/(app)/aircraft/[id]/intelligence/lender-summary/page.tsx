// Aircraft Intelligence — Lender / Insurance Summary.
...
// without a round-trip; the client handles (re)generation and PDF export.
...
import { LenderSummaryClient, type LenderSummaryReport } from './lender-summary-client'

export const dynamic = 'force-dynamic'
export const metadata = { title: 'Lender / Insurance Summary' }

export default async function LenderSummaryPage({ params }: { params: { id: string } }) {
      ...
      <div className="flex flex-col h-full overflow-hidden">
        <Topbar
          ...
          breadcrumbs={[
            ...
            { label: 'Lender / Insurance Summary' },
          ]}
        />
          ...
          <div className="max-w-5xl mx-auto">
            <div className="mt-8 flex flex-col items-center justify-center gap-3 rounded-xl border border-border bg-white py-16 px-6 text-center">
              ...
              <p className="text-xs text-muted-foreground max-w-md">
                ...
                view the Lender / Insurance Summary.
              </p>
            </div>
          </div>
        </main>
  ...
  let initialReport: LenderSummaryReport | null = null
  try {
    ...
    if (cached) {
      initialReport = { ...(cached.result_json as object), cached: true } as LenderSummaryReport
    }
  } catch {
    initialReport = null
  }
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      ...
      />
      <IntelligenceModuleNav aircraftId={aircraftId} active="lender-summary" />
      <main className="flex-1 overflow-y-auto">
        <LenderSummaryClient aircraftId={aircraftId} initialReport={initialReport} />
      </main>
    </div>
  )
}
